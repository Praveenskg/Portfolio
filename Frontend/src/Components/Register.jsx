...
function Register() {
  ...
  const { StoreToken, isDarkMode, API } = useAuth();
              ...
              <div className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`border ${
                      isDarkMode ? "text-black" : "text-black"
                    } placeholder-gray-400 focus:outline-none focus:border-indigo-400 w-full py-4 px-4 text-base block border-gray-300 rounded-md [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
                  />
                </div>
                <div className="relative">
                  <label
